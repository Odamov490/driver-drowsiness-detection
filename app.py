...
# Asl (eski) uslub asos qilib olindi, faqat fon chiroyli qilib yangilandi
st.markdown(
    """
    <style>
    /* Sahifaning umumiy foni — yumshoq, ko'zga yoqimli gradient */
    .stApp {
        background: linear-gradient(160deg, #f5f7fb 0%, #e8eef5 40%, #dfe9f3 100%);
    }
